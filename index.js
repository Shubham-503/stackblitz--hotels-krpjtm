...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  } else if (pricing.toLowerCase() == 'low-to-high') {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  } else if (rating.toLowerCase() == 'low-to-high') {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  if (reviews.toLowerCase() == 'most-to-least') {
    hotelsCopy.sort((a, b) => b.reviews - a.reviews);
  } else if (rating.toLowerCase() == 'least-to-most') {
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  let hotelsFilteredByAmenity = filterByAmenity(hotelsCopy, amenity);
  res.json({ hotels: hotelsFilteredByAmenity });
});
...
app.get('/hotels/filter/country', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  let hotelsFilteredByCountry = filterByCountry(hotelsCopy, country);
  res.json({ hotels: hotelsFilteredByCountry });
});
...
app.get('/hotels/filter/category', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  let hotelsFilteredByCategory = filterByCategory(hotelsCopy, category);
  res.json({ hotels: hotelsFilteredByCategory });
});
